...
class MFRC522:
    ...
    def __init__(self, spi_bus, select_pin, reset_pin):
        """
    ...
    def Write_MFRC522(self, addr, val):
        ...
        self.spi_bus.write(b'%c' % int(0xff & ((addr << 1) & 0x7e)))
        self.spi_bus.write(b'%c' % int(0xff & val))
    ...
    def Read_MFRC522(self, addr):
        ...
        """
        self.select_pin.value(0)
        self.spi_bus.write(b'%c' % int(0xff & (((addr << 1) & 0x7e) | 0x80)))
        val = self.spi_bus.read(1)
        self.select_pin.value(1)
        return val[0]
